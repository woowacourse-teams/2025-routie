...
public class PlaceControllerTest {
    ...
    public void updatePlace() {
        ...
        Map<String, Object> updateRequest = Map.of(
                ...
                "breakStartAt", "12:00",
                "breakEndAt", "13:00",
                "closedWeekdays", List.of("SUNDAY", "MONDAY")
        );
    ...
    public void updatePlaceWithoutBreakTime() {
        ...
        Map<String, Object> updateRequest = Map.of(
                ...
                "openAt", "10:00",
                "closeAt", "22:00",
                "closedWeekdays", List.of("WEDNESDAY")
        );
    ...
    public void updatePlaceWithMaximumStayDuration() {
        ...
        Map<String, Object> updateRequest = Map.of(
                ...
                "breakStartAt", "14:00",
                "breakEndAt", "15:00",
                "closedWeekdays", List.of("SATURDAY", "SUNDAY")
        );
    ...
    public void readPlaceWithDetailValidation() {
        ...
        assertThat(responseBody.get("closedWeekdays")).isInstanceOf(List.class);
    }
}
