...
import type { LoaderStatus, LoaderSnapshot } from '@/libs/map-sdk';

/**
 * useKakaoLoader 훅 반환 타입
 */
 ...
 * ```
 */
const useKakaoLoader = (): UseKakaoLoaderReturn => {
...
export type { UseKakaoLoaderReturn };
