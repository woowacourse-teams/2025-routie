...
class OperationHoursValidatorTest {
    ...
    void shouldReturnValidAndEmptyWhenNoBusinessHoursSet() {
        // given
        final Place place = createMockPlace(null, null);
    ...
    class NormalBusinessHours {
        ...
        void shouldReturnTrueWhenVisitDuringBusinessHours() {
            // given
            final Place place = createMockPlace(openAt, closeAt);
            final RoutiePlace routiePlace = createMockRoutiePlace(place);
            final TimePeriod timePeriod = new TimePeriod(
                    routiePlace,
                    LocalDateTime.of(2024, 1, 1, 10, 0),
    ...
    class MultiplePlacesValidation {
        ...
        void validate_shouldReturnOnlyInvalidPlaces_whenMixed() {
            // given
            final LocalTime openAt = LocalTime.of(9, 0);
            final LocalTime closeAt = LocalTime.of(18, 0);

            // 1. 유효한 장소 (10:00 ~ 11:00 방문)
            final Place validPlace = createMockPlace(openAt, closeAt);
            ...
            final Place invalidPlace = createMockPlace(openAt, closeAt);
    ...
    class EdgeCasesForLogicFlaw {
        ...
        void validate_shouldReturnInvalid_whenVisitSpansOvernightClosingTime() {
            ...
            final Place place = createMockPlace(LocalTime.of(9, 0), LocalTime.of(18, 0));
            final RoutiePlace routiePlace = createMockRoutiePlace(place);
            final TimePeriod timePeriod = new TimePeriod(
                    routiePlace,
